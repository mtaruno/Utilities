...
class Visualize:
    ...
    def onedim_distplot(
        self, data: list, title: str = "Distplot", group_label="distplot", color=None, bin_size = None
    ) -> None:
        ...
        fig = ff.create_distplot(hist_data, group_labels, colors=[color], bin_size = bin_size)
